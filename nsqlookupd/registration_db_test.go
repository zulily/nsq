...
func TestRegistrationDB(t *testing.T) {
	...
	pi1 := &PeerInfo{beginningOfTime.UnixNano(), "1", "remote_addr:1", "host", "tcp_b_addr", 1, "http_b_addr", 2, "v1"}
	pi2 := &PeerInfo{beginningOfTime.UnixNano(), "2", "remote_addr:2", "host", "tcp_b_addr", 2, "http_b_addr", 3, "v1"}
	pi3 := &PeerInfo{beginningOfTime.UnixNano(), "3", "remote_addr:3", "host", "tcp_b_addr", 3, "http_b_addr", 4, "v1"}
